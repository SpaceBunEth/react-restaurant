...
export default function Pagin(props) {
    ...
    for(let i = 1; i <= props.totalPages; i++){
        paginArray.push(
            <>
            <li class="page-item"><a class={props.pageNum == i - 1 ? "page-link disabled" : 'page-link'} onClick={() => {props.setpageNum(i - 1)}}>{i}</a></li>
            </>
        )
    }
    function preBtn(){
